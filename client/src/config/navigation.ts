...
import {
  ...
  FileBarChart, FileStack, Database,
} from 'lucide-react';
import type { LucideIcon } from 'lucide-react';
import type { Role } from '@/config/constants';

export interface NavItem {
  /** Route path (matches App.tsx). */
  to: string;
  /** Short label shown in the sidebar + breadcrumb. */
  label: string;
  /** One-line description for dashboard tool cards. */
  description: string;
  icon: LucideIcon;
  /** Minimum role required to see / reach this item. */
  minRole: Role;
}
