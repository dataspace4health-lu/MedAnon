...
class TestConfig(unittest.TestCase):
    ...
    def test_read_lists(self):
        ...
        config_filename = 'tests/config/redact.yaml'
        resource_filename = 'tests/data/sample_fhir_data/patient_list.json'
    ...
    def test_deidentify_perturb(self):
        ...
        config_filename = 'tests/config/perturb.yaml'
    ...
    def test_deidentify_cryptohash(self):
        ...
        config_filename = 'tests/config/cryptohash.yaml'
        resource_filename = 'tests/data/sample_fhir_data/simple_patient.json'
        resource = read_resource_from_file(resource_filename)
        settings = Settings(config_filename)
    ...
    def test_deidentify_substitute(self):
        ...
        config_filename = 'tests/config/substitute.yaml'
        resource_filename = 'tests/data/sample_fhir_data/simple_patient.json'
        resource = read_resource_from_file(resource_filename)
        settings = Settings(config_filename)
        ret = process_data(resource, settings)
