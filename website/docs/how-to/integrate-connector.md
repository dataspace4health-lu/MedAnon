---
title: "Integrate a Dataspace Connector"
sidebar_position: 15
description: "IDSA/FIWARE dataspace integration patterns (EDC, NGSI-LD)."
---

# Connector Integration

How to connect MedAnon to a dataspace connector, Eclipse Dataspace Components (EDC), FIWARE/NGSI-LD, or any HTTP-based connector, for privacy-preserving FHIR data exchange.
...
- **SSRF protection:** All user-supplied `server_url` values are SSRF-validated before the connection is attempted. See [security.md § 4.3](../explanation/security-model.md#43-ssrf-protection).
