...
Usage
-----
    from medanon_core.analytics.synthetic import generate_synthetic_patients
    ...
    from medanon_core.analytics.synthetic import generate_synthetic_conditions
...
def _make_condition(
    ...
    code = rng.choice(dists["codes"])
    clinical_status = rng.choice(dists["clinical_statuses"])
    category = rng.choice(dists["categories"])
